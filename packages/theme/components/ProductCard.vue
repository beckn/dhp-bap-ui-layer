...
<script>
import { SfImage, SfIcon, SfButton } from '@storefront-ui/vue';
...
export default {
  ...
  props: {
    ...
    pSlotStart: { type: String, default: '' },
    pSlotEnd: { type: String, default: '' },
  ...
  setup(props, { emit }) {
    ...
    const _pSlotStart = computed(() => props.pSlotStart);
    const _pSlotEnd = computed(() => props.pSlotEnd);
